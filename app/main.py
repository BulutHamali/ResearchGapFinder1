...
async def analyze(request: AnalysisRequest):
    """
    Full research gap analysis pipeline.

    Retrieves papers, clusters them, detects gaps, generates hypotheses,
    ...
    try:
        ...
        # 9. LLM setup
        # Temporarily update settings with preset
        from app.config import Settings
        preset_settings = settings
        reasoner = LLMReasoner(preset_settings)

        # Override model from request preset
